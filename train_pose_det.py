...
def train():
    ...
    params_list = [{'params': pg_fixed, 'lr': 0.0},
                   {'params': pg0}]
    if opt.adam:
        ...
        optimizer = optim.SGD(params_list, lr=hyp['lr0'], momentum=hyp['momentum'],
        ...
        if opt.prebias:
            ...
            if not (opt.notest or (opt.nosave and epoch < 10)) or final_epoch:
                with torch.no_grad():
                    ...
                    results, maps = test.test(None,  # 该脚本没有cfg，所以none
                                              data,
                                              batch_size=batch_size,
                                              img_size=opt.img_size,
                                              model=model,
